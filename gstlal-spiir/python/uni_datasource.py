...
def mkwhitened_src(pipeline, src, max_rate, instrument, psd = None,
		...
		veto_segments = None, nxydump_segment = None,
	...
	head = datasource.mkhtgate(pipeline, head, threshold = ht_gate_threshold if ht_gate_threshold is not None else float("+inf"), attack_length = ht_gate_window, hold_length = ht_gate_window, name = "%s_ht_gate" % instrument)
