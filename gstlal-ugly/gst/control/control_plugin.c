...
static gboolean plugin_init(GstPlugin *plugin)
{
	struct {
		...
		{"control_timeshift", CONTROL_TIMESHIFT_TYPE},
		{NULL, 0},
	};
...
GST_PLUGIN_DEFINE(GST_VERSION_MAJOR, GST_VERSION_MINOR, "control", "control elements", plugin_init, PACKAGE_VERSION, "GPL", PACKAGE_NAME, "http://www.lsc-group.phys.uwm.edu/daswg")
