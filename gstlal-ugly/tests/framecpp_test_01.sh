...
gst-launch-1.0 audiotestsrc wave=9 samplesperbuffer=89 num-buffers=3000 ! audio/x-raw-float, width=32, rate=1024 ! tee name="src" ! lal_nxydump ! filesink sync=false async=false location="framecpp_test_01_in.dump" src. ! .H2:FAKE-DATA framecpp_channelmux ! framecpp_channeldemux .H2:FAKE-DATA ! lal_nxydump ! filesink sync=false async=false location="framecpp_test_01_out.dump"
