...
def mkcudamultiratespiir(pipeline, src, bank_struct, bank_id = 0, gap_handle = 0, name = None):
	properties = dict((name, value) for name, value in (("name", name), ("spiir_bank", bank_struct), ("bank_id", bank_id), ("gap_handle", gap_handle)) if value is not None)
