/*
 * Copyright (C) 2008,2011,2013--2015  Kipp Cannon, Chad Hanna
...
static gpointer register_tags(gpointer unused)
{
	...
	gst_tag_register(GSTLAL_TAG_PHASE, GST_TAG_FLAG_META, G_TYPE_FLOAT, "phase", "ADC heterodyne phase calibration.", NULL);
	gst_tag_register(GSTLAL_TAG_DATAVALID, GST_TAG_FLAG_META, G_TYPE_UINT, "datavalid", "ADC data valid flag.", NULL);
