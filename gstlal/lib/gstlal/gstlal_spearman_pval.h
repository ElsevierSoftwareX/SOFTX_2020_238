...
*/
/* unsigned gstlal_spearman(double *, const complex double *, unsigned, int, double, const gsl_matrix_complex *, const gsl_matrix_int *, const gsl_vector *); */
unsigned gstlal_spearman_float(float *, const float complex *, unsigned, int, double, const gsl_matrix_complex *, const gsl_matrix_int *, const gsl_vector *);
