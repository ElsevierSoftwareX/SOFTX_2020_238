...
class ratebinlist(segments.segmentlist):
	...
	def add_ratebin(self, seg, count):
		...
		[10@[0,20)]
		"""
		# implementation of .__ior__() allows us to use a tuple
		# here
		self |= (ratebin(seg, count = count),)
...
class triggerrates(segments.segmentlistdict):
	...
	...
	>>> x
	{'V1': [7@[0,15), 7@[25,35)], 'H1': [5@[0,10), 5@[20,30)]}
	>>> y = x.copy()
	>>> y
	{'V1': [7@[0,15), 7@[25,35)], 'H1': [5@[0,10), 5@[20,30)]}
	>>> y == x
	...
	>>> y
	{u'V1': [7@[0.0,15.0), 7@[25.0,35.0)], u'H1': [5@[0.0,10.0), 5@[20.0,30.0)]}
	>>> y == x
	True
	>>> y is x
	False
