...
def create_rate_vs_ifar_plot(axes, zerolag_stats, fapfar, is_open_box=False, stair_steps=False):
...
def create_rate_vs_lnL_plot(axes, zerolag_stats, fapfar, is_open_box):
	axes.semilogy()
...
def create_rate_vs_lnL_plot_fig3(axes, zerolag_stats, background_stats, fapfar):
	#
	# plot limits and expected counts
	#
