# -*- coding: utf-8 -*-
#
# GstLAL documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'GstLAL.tex', u'GstLAL Documentation',
     u'Kipp Cannon, Chad Hanna', 'manual'),
]
...
man_pages = [
    (master_doc, 'gstlal', u'GstLAL Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GstLAL', u'GstLAL Documentation',
     author, 'GstLAL', 'One line description of project.',
     'Miscellaneous'),
]
