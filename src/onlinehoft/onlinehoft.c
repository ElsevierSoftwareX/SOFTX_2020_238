...
{
    {0, 90, 0, "H1", "H-H1_DMT_C00_L2-", "-16.gwf", "H1:DMT-STRAIN"},
    {0, 90, 0, "H2", "H-H2_DMT_C00_L2-", "-16.gwf", "H2:DMT-STRAIN"},
    {0, 90, 0, "L1", "L-L1_DMT_C00_L2-", "-16.gwf", "L1:DMT-STRAIN"},
    {0, 90, 0, "V1", "V-V1_DMT_HREC-",   "-16.gwf", "V1:DMT-STRAIN"},
    {0, 0, 0, 0, 0, 0, 0}
};
